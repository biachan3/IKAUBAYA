                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mt-4 mt-md-5">
                                            ...
                                            <div class="section pl-5">
                                                ...
                                                <p>
                                                    <strong>VICTOR TETT</strong>
                                                    - Hands-on With ARIA:
                                                    Accessibility Recipes for
                                                    Web Apps
                                                </p>
                                                <p>
                                                    <strong>PETER REX</strong> -
                                                    Apps and Tools to Support
                                                    LGBTQ Youth This Spirit Day
                                                </p>
                                                <p>
                                                    <strong>IVAN JELIC</strong>
                                                    - Training an Image
                                                    Classification Model With
                                                    Create ML
                                                </p>
                                                <p>
                                                    <strong>NIA JOHNSON</strong>
                                                    - Practical Test-Driven
                                                    Development
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 mt-4 mt-lg-0">
                                            <div class="pass-wrap">
                                                ...
                                                <p class="mt-4">
                                                    <em></em> seat in 7-10 row
                                                </p>
                                                <p class="mt-2">
                                                    <em></em> free drink
                                                </p>
                                                <p class="mt-2">
                                                    <em></em> event on flash
                                                    drive
                                                </p>
                                                <p class="mt-2 mb-5 mb-sm-0">
                                                    <em class="no"></em>
                                                    speakers support
                                                </p>
                                        ...
                                        <div class="col-lg-9 mt-4 mt-lg-5">
                                            <div class="pass-wrap">
                                                ...
                                                <p class="mt-4">
                                                    <em></em> seat in 1-3 row
                                                </p>
                                                <p class="mt-2">
                                                    <em></em> 10 free drinks
                                                </p>
                                                <p class="mt-2">
                                                    <em></em> event on flash
                                                    drive
                                                ...
                                                <p class="mt-2 mb-5 mb-sm-0">
                                                    <em></em> speakers support
                                                </p>
                                                <a href="#" class="btn-pass-4"
                                                    >get ticket - $125</a
                                                >
                                            </div>
                                        </div>
